...
public class Ssh {
	 ...
	 * Method to connect session with hostname, username and password
	 * */
	...
	/* Created By - Shivendra Singh
	 * Method to send command to remote machine
	 * */
	...
	/* Created By - Shivendra Singh
	 *  Method to copy Agent from Linux machine to Windows VM 
	 *  */
	...
	/* Created By - Shivendra Singh
	 *  Method to close channel connection 
	 *  */
